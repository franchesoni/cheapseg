...
train_dataloader = dict(batch_size=BATCH_SIZE, num_workers=NUM_WORKERS, persistent_workers=False, dataset=dict(data_root=data_root))
val_dataloader = dict(batch_size=1, num_workers=NUM_WORKERS, persistent_workers=False, dataset=dict(data_root=data_root))
